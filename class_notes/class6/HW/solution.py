...
class StringCount:
    ...
    #  ---removed regex import as this gave 1 w/ the test string as well
    #  def find_bob(self):
...
class SortWords:
    ...
    def split_alpha(self):
        new_text = ''
        sorted_text = self.str_input.split(",")
        sorted_text = sorted(sorted_text, key = str.lower)
        new_text = sorted_text[0]
        for i in range(1, len(sorted_text)):
            new_text += "," + sorted_text[i]
        return new_text
...
print(question5.split_alpha())


#  Ask the user to enter a string, and check if it is a palindrome.
#  If yes, print True, or else print False.

question6a = PalindromeChecker("Suresh")
print(question6a.check_palindrome())

question6b = PalindromeChecker("pullup")
print(question6b.check_palindrome())

question6c = PalindromeChecker("Aibohphobia")
print(question6b.check_palindrome())
